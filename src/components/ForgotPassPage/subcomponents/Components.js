...
export const FormContainer = styled.div`
  ...
  height: 100%;
`
export const OTPgenContainer = styled.div`
  position: relative;
  height: 100%;
  ...
  z-index:5;`
      : null}
`
export const OTPgenContainerMobile = styled.div`
  position: relative;
  height: 100%;
  transition: all 0.6s ease-in-out;
  width: 100%;
  ...
  z-index:5;`
      : null}
`
export const OTPsubmitContainer = styled.div`
  position: relative;
  height: 100%;
  transition: all 0.6s ease-in-out;
  width: 50%;
  ...
  opacity: 0;`
      : null}
`
export const OTPsubmitContainerMobile = styled.div`
  position: relative;
  height: 100%;
  transition: all 0.6s ease-in-out;
  width: 100%;
